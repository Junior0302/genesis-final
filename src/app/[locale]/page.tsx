export default async function Home({
  ...
  const content = {
    fr: {
      ...
      subtitle:
        "Nous preparons actuellement une mise a jour premium du site. L'experience complete sera bientot de retour.",
    ...
    en: {
      ...
      subtitle:
        "We are currently preparing a premium update of the website. The full experience will be back soon.",
    ...
    zh: {
      eyebrow: "Genesis Connect Studio",
      title: "网站开发中",
      subtitle: "我们正在准备网站的高端更新版本，完整体验即将回归。",
      availability: "即将上线",
      contactLabel: "联系",
      contactValue: "hello@genesisconnectstudio.com",
      contactCta: "发送邮件",
